<?php
	...
	function field_type_edit__taxonomy_settings($field){
...
<table class="form-table">
	...
	<tbody>
		<tr class="title">
			<td colspan="2"><h2>Reed Write</h2></td>
		</tr>
	...
	<tbody>
		...
		<tbody id="rewrite_options"<?php echo $arguments['rewrite_type'] != '2' ? ' style="display: none;"' : ''; ?>>
			...
			<tr>
				<th>Hierarchical</th>
				<td><input type="checkbox" class="hierarchical" name="arguments[rewrite_hierarchical]" <?php value_type('1', $arguments['rewrite_hierarchical'], 'checked'); ?>/> <span class="description">Allow hierarchical urls.</span></td>
			</tr>
			<tr>
